document.addEventListener("DOMContentLoaded",(function(){Array.from(document.getElementsByClassName("confirm-action")).forEach((function(n){n.addEventListener("click",(function(n){confirm("Are you sure you want to do this?")||n.preventDefault()}))}))}));
