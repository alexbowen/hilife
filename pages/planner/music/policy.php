...
<h5>Music Policy</h5>
    ...
    <div class="row mb-3">
      <div class="col">
        ...
        <textarea name="noplay" class="form-control"><?php echo $event_music['noplay']; ?></textarea>
      </div>
    </div>
    ...
    <div class="row mb-3">
      <div class="col">
        ...
        <textarea name="cheese" class="form-control"><?php echo $event_music['cheese']; ?></textarea>
      </div>
    </div>
    </div>
...
<h5>DJ interaction</h5>
    <div class="row mb-3">
      <div class="col">
        ...
        <div class="form-radio">
          <input type="radio" id="requests-1" name="requests" class="form-check-input" value="strict" <?php if ($event_music['requests'] == 'strict') { ?>checked<?php } ?>>
          <label class="form-check-label" for="requests-1">Only play requests that fit our music selection</label>
        </div>

        <div class="form-radio">
          <input type="radio" id="requests-2" name="requests" class="form-check-input" value="discretion" <?php if ($event_music['requests'] == 'discretion') { ?>checked<?php } ?>>
          <label class="form-check-label" for="requests-2">Leave it to the discretion of the DJ</label>
        </div>

        <div class="form-radio">
          <input type="radio" id="requests-3" name="requests" class="form-check-input" value="play" <?php if ($event_music['requests'] == 'play') { ?>checked<?php } ?>>
    ...
    <div class="row mb-3">
      <div class="col">
        ...
        <div class="form-radio">
          <input type="radio" id="mic-1" name="mic" class="form-check-input" value="yes" <?php if ($event_music['mic'] == 'yes') { ?>checked<?php } ?> />
          <label class="form-check-label" for="mic-1">Yes, this is what we want</label>
        </div>

        <div class="form-radio">
          <input type="radio" id="mic-2" name="mic" class="form-check-input" value="no" <?php if ($event_music['mic'] == 'no') { ?>checked<?php } ?>/>
