...
<div class="col">
  <div class="input-group mb-1">
    <select name="booking_type" id="filter-type" class="form-select form-select-sm col-sm-8" data-auto-submit="true">
      ...
      <option value="direct" <?php if($_GET['booking_type'] == 'direct') { ?>selected<?php } ?>>direct</option>
      <option value="package" <?php if($_GET['booking_type'] == 'package') { ?>selected<?php } ?>>package</option>
    </select>
  </div>
  <noscript>
    <div class="col">
