<?php
include $_SERVER['DOCUMENT_ROOT'].'/lib/event/model.php';
    ...
    <div class="row">
      <div class="col-12 col-md-6">
        ...
        <?php foreach ($clients as $key => $client) { ?>
          <option value="<?php echo $client['id']; ?>" <?php if ($_POST['client'] == $client['id']) { ?>selected<?php } ?>><?php echo $client['venue_name']; ?></option>
        <?php } ?>
        </select>
      </div>
